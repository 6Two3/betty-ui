...
export const IconDenom: React.FC<{ denom: Denom | string }> = ({ denom }) => {
  const warning =
    typeof denom !== "string" &&
    denom.trace &&
  ...
  return warning ? (
    <IconWarning className="color-red icon-denom" data-tip={warning} />
  ) : (
    <IconDenomInner denom={denom} />
  );
};
const IconDenomInner: React.FC<{ denom: Denom | string }> = ({ denom }) => {
  if (!denom) return null;
  const token = typeof denom === "string" ? denom : denom.symbol.toLowerCase();
  ...
  switch (token.split(".").at(0)) {
    ...
    case "sol":
    case "whsol":
      return <img className="icon-denom" src={sol.src} alt="SOL" />;

    case "mnta":
      return <img className="icon-denom" src={mnta.src} alt="MNTA" />;
    case "wink":
      return <img className="icon-denom" src={wink.src} alt="WINK" />;
    case "neok":
      return <img className="icon-denom" src={neok.src} alt="NEOK" />;

    case "plnk":
      return <img className="icon-denom" src={plnk.src} alt="PLNK" />;
    ...
    case "rac":
      return <img className="icon-denom" src={rac.src} alt="RAC" />;
...
const IconDEMO = () => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id={`demo_${id}`}>
...
const IconWMatic = () => (
  ...
  >
    <g fill="none" fillRule="evenodd">
      ...
      />
      <path fill="#2BBDF7" d="M68.012 126.131v72.858l29.993-17.283v-38.287z" />
    </g>
  </svg>
);
